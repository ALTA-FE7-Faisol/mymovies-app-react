    ...
    return (
      <div className="p-3 flex flex-col justify-between bg-neutral-500 rounded shadow-lg shadow-black">
        <Link to={this.props.navigate}>
          <img src={this.props.image ? `https://image.tmdb.org/t/p/original${this.props.image}` : "https://via.placeholder.com/500x750?text=No+Image"} alt={this.props.title} height="750" />
